...
Cette FAQ est la synthèse des échanges qui se sont tenus lors de
l'hackathon « [Comment améliorer le dépôt et le partage de données
de recherche ?](https://mi-gt-donnees.pages.math.unistra.fr/fair/)
" ». Elle est depuis enrichie régulièrement des
discussions sur la liste données.
...
* [Quels sont les principaux points de vigilance à respecter sur le plan juridique avant de déposer un jeu de données dans un entrepôt ?](#juridicque)
* [Quelles sont les conditions de réutilisation des données de la recherche déposée dans un entrepôt de données ?](#exception)
* [Ou peut-on trouver des listes de revues publiant des data-papers](#ouliste)![](images/new.gif)![](images/new.gif)
* [Est-il possible de publier un nouveau data-paper si les données ont évolué ?](#evoluer)![](images/new.gif)![](images/new.gif)
* [Qu'est ce qu'un data-paper ?](#datapaper)![](images/new.gif)![](images/new.gif)
...
### Quelle licence choisir ? {#choisir}
