...
description: Cette FAQ est la synthèse des échanges qui se sont tenus lors de l'hackathon «[Comment améliorer le dépôt et le partage de données de recherche ?](https://mi-gt-donnees.pages.math.unistra.fr/fair/)». Elle est depuis enrichie régulièrement des discussions sur la liste données.
format:
   html:
